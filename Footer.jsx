// NAVO Footer Component
const NAVOFooter = ({ navigate }) => {
  const footerStyle = {
        ...
        <div style={gridStyle}>
          ...
          <div>
            ...
            <div style={socialStyle}>
              {socials.map(s => (
                <div key={s.name} style={socialBtnStyle} title={s.name}
          ...
          {/* Sections */}
          <div>
            <div style={colTitleStyle}>Sections</div>
            {cats.map(c => (
              <button key={c} style={linkStyle} onClick={() => navigate('category', c)}
          ...
          {/* Legal */}
          <div>
            <div style={colTitleStyle}>Legal</div>
